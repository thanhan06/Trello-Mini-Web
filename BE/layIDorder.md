...
Nói ngắn gọn cho khách hàng: `MAX` là tự đếm bằng tay nên dễ nhầm khi nhiều người dùng cùng lúc, còn `SEQUENCE` là database tự phát số nên ổn định và an toàn hơn.